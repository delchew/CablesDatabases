...
INSERT INTO CABLE_SHORT_NAME (SHORT_NAME) VALUES ('КЭВ(Э)В');
INSERT INTO CABLE_SHORT_NAME (SHORT_NAME) VALUES ('КЭРс(Э)');
INSERT INTO CABLE_SHORT_NAME (SHORT_NAME) VALUES ('КИП');
INSERT INTO CABLE_SHORT_NAME (SHORT_NAME) VALUES ('КПСВ(Э)');
INSERT INTO CABLE_SHORT_NAME (SHORT_NAME) VALUES ('КПС(Э)');
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
